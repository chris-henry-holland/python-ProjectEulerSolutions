...
def blumBlumShubPseudoRandomLineSegmentGenerator(
        n_dim: int=2,
        s_0: int=290797,
        s_mod: int=50515093,
        t_min: int=0,
...
def blumBlumShubPseudoRandomTwoDimensionalLineSegmentsCountInternalCrossings(
    ...
    blumBlumShubPseudoRandomLineSegmentGenerator() for the given parameters,
    ...
    of blumBlumShubPseudoRandomLineSegmentGenerator(), from which (for the
    ...
    """
    #since = time.time()
    it = iter(blumBlumShubPseudoRandomLineSegmentGenerator(
        n_dim=2,
